...
class AllDelivered extends StatefulWidget {
  const AllDelivered({super.key});

  @override
  State<AllDelivered> createState() => _AllDeliveredState();
}

class _AllDeliveredState extends State<AllDelivered> {
  List<dynamic> list = [];
  ...
  getData() async {
    var t = await FirebaseFirestore.instance
        ...
        .get();
    var s = List.from(t["successfulDeliveryOrders"]);
    setState(() {
      list = s;
    });
  }
